...
// value
	...
	public int hashCode () {
		final int prime = 31;
		int result = 1;
		result = prime * result + floatToRawIntBits(w);
		result = prime * result + floatToRawIntBits(x);
		result = prime * result + floatToRawIntBits(y);
		result = prime * result + floatToRawIntBits(z);
		return result;
	}
	...
	public boolean equals (Object obj) {
		...
		return (floatToRawIntBits(w) == floatToRawIntBits(other.w))
			&& (floatToRawIntBits(x) == floatToRawIntBits(other.x))
