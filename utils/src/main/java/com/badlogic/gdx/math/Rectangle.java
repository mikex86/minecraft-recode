...
public class Rectangle implements Serializable, Shape2D {
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + floatToRawIntBits(height);
        result = prime * result + floatToRawIntBits(width);
        result = prime * result + floatToRawIntBits(x);
        result = prime * result + floatToRawIntBits(y);
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (floatToRawIntBits(height) != floatToRawIntBits(other.height)) return false;
        if (floatToRawIntBits(width) != floatToRawIntBits(other.width)) return false;
        if (floatToRawIntBits(x) != floatToRawIntBits(other.x)) return false;
        if (floatToRawIntBits(y) != floatToRawIntBits(other.y)) return false;
        return true;
    }
