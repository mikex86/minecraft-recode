...
public class HudTextures extends TextureWrapper {
    ...
    public void drawSelectionCross(int x, int y, int size) {
        drawUVRect(x, y, size, size, selectionCrossUV, selectionCrossSizes, 1, 1, 1, 1);
    }
    ...
    public void drawHeart(int x, int y, int size) {
        drawUVSquare(x, y, size, heartUV, heartSizes, 1, 1, 1, 1);
    }
    ...
    public void drawHalfHeart(int x, int y, int size) {
        drawUVSquare(x, y, size, this.halfHeartUV, heartSizes, 1, 1, 1, 1);
    }
    ...
    public void drawWhiteBGHeart(int x, int y, int size) {
        drawUVSquare(x, y, size, this.whiteBGHeartUV, heartSizes, 1, 1, 1, 1);
    }
    ...
    public void drawBlackBGHeart(int x, int y, int size) {
        drawUVSquare(x, y, size, this.blackBGHeartUV, heartSizes, 1, 1, 1, 1);
    }
}
